...
$.oc.langMessages['pt-br'] = $.extend(
    $.oc.langMessages['pt-br'] || {},
    {
        ...
        "colorpicker": {"choose": "Ok"},
        "filter": {
            "group": {"all": ""},
            "scopes": {"apply_button_text": "Aplicar", "clear_button_text": "Limpar"},
            "dates": {
                "all": "todas",
                "filter_button_text": "Filtro",
                "reset_button_text": "Reiniciar",
                "date_placeholder": "Data",
                "after_placeholder": "Inicial",
                "before_placeholder": "Final"
            },
            "numbers": {
                "all": "todas",
        ...
        "eventlog": {
            ...
            "tabs": {"formatted": "Formatado", "raw": "Bruto"},
            "editor": {
