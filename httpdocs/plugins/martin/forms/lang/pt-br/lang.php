    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'uploader_pholder'  => ['title' => 'texto do Placeholder'         , 'description' => 'Texto a ser exibido quando nenhum arquivo é carregado', 'default' => 'Clique ou arraste os arquivos'],
                ...
                'uploader_browse_button' => ['title' => 'Texto do botão de upload' , 'description' => 'Texto do botão para procurar arquivo' , 'default' => 'Buscar'],
            ]
        ],
        'settings' => [
