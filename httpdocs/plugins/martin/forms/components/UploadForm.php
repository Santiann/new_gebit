<?php
    ...
    class UploadForm extends MagicForm {
        ...
        public function init() {
            ...
            $this->browseButtonText = $this->property('browseButtonText');
        ...
        public function defineProperties() {
            $local = [
                ...
                'browseButtonText' => [
                    'title'             => 'martin.forms::lang.components.shared.uploader_browse_button.title',
                    'description'       => 'martin.forms::lang.components.shared.uploader_browse_button.description',
                    'default'           => Lang::get('martin.forms::lang.components.shared.uploader_browse_button.default'),
                    'type'              => 'string',
                    'group'             => 'martin.forms::lang.components.shared.group_uploader',
                    'showExternalParam' => false,
                ],
