...
class Snippet
{
    ...
    public static function extendPartialForm($formWidget)
    {
        ...
        $fieldConfig = [
            'tab'     => 'general.paginas::lang.snippet.partialtab',
            'type'    => 'text',
            'label'   => 'general.paginas::lang.snippet.code',
            'comment' => 'general.paginas::lang.snippet.code_comment',
            'span'    => 'left'
        ];
        ...
        $fieldConfig = [
            'tab'     => 'general.paginas::lang.snippet.partialtab',
            'type'    => 'text',
            'label'   => 'general.paginas::lang.snippet.name',
            'comment' => 'general.paginas::lang.snippet.name_comment',
            'span'    => 'right'
        ];
        ...
        $fieldConfig = [
            ...
            'columns' => [
                'title' => [
                    'title' => 'general.paginas::lang.snippet.column_property',
                    'validation' => [
                        'required' => [
                ...
                'property' => [
                    'title' => 'general.paginas::lang.snippet.column_code',
                    'validation' => [
                        'required' => [
                        ...
                        'regex' => [
                            'pattern'   => '^[a-z][a-z0-9]*$',
                            'modifiers' => 'i',
                            'message'   => Lang::get('general.paginas::lang.snippet.property_format_error')
                        ]
                    ]
                ],
                'type' => [
                    'title'   => 'general.paginas::lang.snippet.column_type',
                    'type'    => 'dropdown',
                    'options' => [
                        'string'   => 'general.paginas::lang.snippet.column_type_string',
                        'checkbox' => 'general.paginas::lang.snippet.column_type_checkbox',
                        'dropdown' => 'general.paginas::lang.snippet.column_type_dropdown'
                    ],
                    'validation' => [
                        'required' => [
                            'requiredWith' => 'title'
                ...
                'default' => [
                    'title' => 'general.paginas::lang.snippet.column_default'
                ],
                'options' => [
                    'title' => 'general.paginas::lang.snippet.column_options'
                ]
            ]
        ];
    ...
    protected static function preprocessPropertyValues($theme, $snippetCode, $componentClass, $properties)
    {
        ...
        if (!$snippet) {
            throw new ApplicationException(Lang::get('general.paginas::lang.snippet.not_found', ['code' => $snippetCode]));
        }
            ...
            if (count($parts) > 1 ) {
                ...
                if (strlen($key)) {
                    if (!preg_match('/^[0-9a-z-_]+$/i', $key)) {
                        throw new ValidationException(['snippetProperties' => sprintf(Lang::get('general.paginas::lang.snippet.invalid_option_key'), $key)]);
                    }
