...
+function ($) { "use strict";
    ...
    RichEditor.prototype.init = function (){
        ...
        var redactorOptions = {
            ...
            ////////////////////////////////////////////////////////////////////////
            //Modifica��es para evitar a altera��o do html dentro do redactor.
        ...
        redactorOptions.plugins = ['video', 'fontcolor', 'fullscreen', 'figure', 'table', 'pagelinks', 'mediamanager']
        redactorOptions.buttons = ['html', 'formatting', 'bold', 'italic','unorderedlist', 'orderedlist',
