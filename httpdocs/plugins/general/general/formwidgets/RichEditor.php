...
class RichEditor extends FormWidgetBase
{
    ...
    public function loadAssets()
    {
        ...
        $this->addJS('js/../vendor/redactor/redactor.js');

        $this->addJS('js/plugin.fullscreen.js');
        $this->addJS('js/plugin.figure.js');
        $this->addJS('js/plugin.table.js');
        $this->addJS('js/plugin.pagelinks.js');
        $this->addJS('js/plugin.fontcolor.js');
        $this->addJS('js/plugin.video.js');
