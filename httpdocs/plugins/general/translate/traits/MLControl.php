<?php namespace General\Translate\Traits;
...
trait MLControl
{
    ...
    /**
     * @var General\Translate\Models\Locale Object
     */
    ...
    {
        $this->addJs('/plugins/general/translate/assets/js/multilingual.js', 'General.Translate');
        $this->addCss('/plugins/general/translate/assets/css/multilingual.css', 'General.Translate');

        if (!class_exists('System')) {
            $this->addCss('/plugins/general/translate/assets/css/multilingual-v1.css', 'General.Translate');
        }
    }
    ...
    public function getLocaleValue($locale)
    {
        ...
        elseif ($this->objectMethodExists($this->model, 'getAttributeTranslated') && $this->defaultLocale->code != $locale) {
            $value = $this->model->noFallbackLocale()->getAttributeTranslated($key, $locale, ($this->config->type == 'repeater' || $this->config->type == 'mlrepeater'));
        }
        else {
