 ...
 *
 *   public $implement = ['@General.Translate.Behaviors.TranslatableCmsObject'];
 *
 *   public $translatable = ['title', 'markup'];
 *
 * This definition is optional and defaults to General\Translate\Classes\MLCmsObject
 *
 *   public $translatableModel = 'General\Translate\Classes\MLStaticPage';
 *
 */
class TranslatableCmsObject extends TranslatableBehavior
{
    ...
    public function getTranslatableModelClass()
    {
        ...
        return 'General\Translate\Classes\MLCmsObject';
    }
