 ...
 *
 *   public $implement = ['@General.Translate.Behaviors.TranslatablePageUrl'];
 *
 */
class TranslatablePageUrl extends ExtensionBase
{
    ...
    {
        if ($this->model instanceof \General\Paginas\Classes\Page) {
    ...
    public function initTranslatableContext()
    {
        ...
        $this->translatableContext = $translate->getLocale(true);
