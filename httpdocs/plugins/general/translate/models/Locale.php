...
class Locale extends Model
{
     ...
     */
    public $table = 'general_translate_locales';
    ...
    {
        if ($this->is_default) {
            throw new ApplicationException(Lang::get('general.translate::lang.locale.delete_default', ['locale'=>$this->name]));
        }
    }
    ...
    public function beforeUpdate()
    {
        if ($this->isDirty('is_default')) {
            ...
            if (!$this->is_default) {
                throw new ValidationException(['is_default' => Lang::get('general.translate::lang.locale.unset_default', ['locale'=>$this->name])]);
            }
        }
    }
    ...
    {
        if (!$this->is_enabled) {
            throw new ValidationException(['is_enabled' => Lang::get('general.translate::lang.locale.disabled_default', ['locale'=>$this->name])]);
        }
    ...
    public static function getDefault()
    {
        ...
        return self::$defaultLocale = self::where('is_default', true)
            ->remember(1440, 'general.translate.defaultLocale')
            ->first()
        ;
    }
    ...
    public static function listEnabled()
    {
        ...
        $isEnabled = Cache::remember('general.translate.locales', 1440, function() {
    ...
    {
        Cache::forget('general.translate.locales');
        Cache::forget('general.translate.defaultLocale');
    }
}
