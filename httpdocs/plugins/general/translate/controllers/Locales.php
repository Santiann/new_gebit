...
class Locales extends Controller
{
    ...
    public $requiredPermissions = ['general.translate.manage_locales'];
    ...
    public function __construct()
    {
        ...
        SettingsManager::setContext('General.Translate', 'locales');

        $this->addJs('/plugins/general/translate/assets/js/locales.js');
    }
