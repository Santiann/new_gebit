<?php namespace General\Translate\Controllers;

use Backend\Behaviors\ImportExportController;
use Lang;
use Flash;
use General\Translate\Models\MessageExport;
use Request;
use BackendMenu;
...
class Messages extends Controller
{
    ...
    public $requiredPermissions = ['general.translate.manage_messages'];
    ...
    public function __construct()
    {
        ...
        SettingsManager::setContext('General.Translate', 'messages');

        $this->addJs('/plugins/general/translate/assets/js/messages.js');
        $this->addCss('/plugins/general/translate/assets/css/messages.css');
    ...
    public function index()
    {
        ...
        $this->pageTitle = 'general.translate::lang.messages.title';
        $this->prepareTable();
    }
    ...
    public function onClearCache()
    {
        ...
        Flash::success(Lang::get('general.translate::lang.messages.clear_cache_success'));
    }
    ...
    public function onScanMessages()
    {
        ...
        Flash::success(Lang::get('general.translate::lang.messages.scan_messages_success'));
    ...
    protected function processTableData($messages, $from, $to)
    {
        ...
        foreach ($messages as $message) {
            ...
            $data[] = [
                ...
                'to' => $toContent,
                'found' => $message->found ? '' : Lang::get('general.translate::lang.messages.not_found'),
            ];
        }
