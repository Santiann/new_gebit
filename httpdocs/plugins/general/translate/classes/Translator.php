...
class Translator
{
    ...
    const SESSION_LOCALE = 'general.translate.locale';

    const SESSION_CONFIGURED = 'general.translate.configured';
    ...
    public function isConfigured()
    {
        ...
        elseif (App::hasDatabase() && Schema::hasTable('general_translate_locales')) {
