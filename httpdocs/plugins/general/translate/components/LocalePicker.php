<?php namespace General\Translate\Components;
...
{
    /**
     * @var \General\Translate\Classes\Translator Translator object.
     */
    ...
    {
        return [
            'name'        => 'general.translate::lang.locale_picker.component_name',
            'description' => 'general.translate::lang.locale_picker.component_description',
        ];
    }
    ...
    public function onRun()
    {
        ...
        $this->page['activeLocale'] = $this->activeLocale = $this->translator->getLocale(true);
