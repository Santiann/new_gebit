...
return [
    ...
    'dynamic_view_template' => [
        'index' => ['formHeadingHtml', 'formBodyHtml', 'crudName', 'crudNameCap', 'modelName', 'viewName', 'routeGroup', 'primaryKey', 'datatableColumns'],
        'form' => ['formFieldsHtml','viewName','routeGroup'],
