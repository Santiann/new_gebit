<div class="box-footer BotesFixoTopo">
    <a href="{{ url('/compromisso_financeiro')}}" class="btn btn-default">
...
<div class="box-body">
    ...
    <div class="tab-content">
        <div class="active tab-pane" id="form_geral">@include ('sistema.compromisso_financeiro.formGeral')</div>
        <div class="tab-pane" id="form_documento">@include ('sistema.compromisso_financeiro.formUpload')</div>
    </div>
    @if ($errors->any())
        <div class="row">
            <div class="col-xs-12">
