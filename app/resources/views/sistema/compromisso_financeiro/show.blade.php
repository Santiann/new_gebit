...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ url('/compromisso_financeiro')}}">{{ $page_title ?? "Page Title" }}</a></li>
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-tools">
            <a href="{{ url('/compromisso_financeiro') }}" title="Back"><button class="btn btn-default btn-xs"><i class="fa fa-arrow-left" aria-hidden="true"></i> Voltar</button></a>
            @permission('compromisso-edit')
            <a href="{{ url('/compromisso_financeiro/' . $compromisso->a022_id_compromisso . '/edit') }}" title="Edit Compromisso"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
            @endpermission
