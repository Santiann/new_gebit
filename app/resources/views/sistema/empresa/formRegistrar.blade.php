    ...
    <div class="jGeral">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="row">
                    <div class="col-md-12">
                    {!! Form::label('tipo', 'Informações de Usuário', ['class' => 'control-label']) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('a001_cpf') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('a001_cpf', null, ['class' => 'form-control cpfMask cpfvalido buscaexistente','autocomplete' => 'off', 'required' => 'required']) !!}
                    ...
                    <div class="col-md-12">
                        <div class="form-group  {{ $errors->has('a001_email') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('a001_email', null, ['class' => 'form-control emailvalido validaunico', 'columnname'=>'a001_email', 'tablename'=>'t001_usuario' ,'pknametable'=>'a001_id_usuario', 'pkVal'=>'0','autocomplete' => 'off', 'required' => 'required', 'maxlength'=>'50']) !!}
                            {!! $errors->first('a005_email', '<p class="help-block">:message</p>') !!}
                            <div class="help-block with-errors "></div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('a001_nome_completo') ? 'has-error' : ''}}">
                            {!! Form::label('a001_nome_completo', 'Nome Completo*', ['class' => 'control-label']) !!}
                            {!! Form::text('a001_nome_completo', null, ['class' => 'form-control','autocomplete' => 'off', 'maxlength'=>'50', 'required' => 'required']) !!}
                            {!! $errors->first('a001_nome_completo', '<p class="help-block">:message</p>') !!}
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::label('tipo', 'Informações da Empresa', ['class' => 'control-label']) !!}
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group {{ $errors->has('a005_logo') ? 'has-error' : ''}}">
                            ...
                            <div class=" ">
                                {!! Form::file('a005_logo', ['class' => 'a005_logo jInputFileUploadImg dropify', 'id'=>'a005_logo',"multiple"=>"multiple", "data-default-file"=>asset('/img/sem-image.jpg'), 'data-height'=>"225" ]) !!}
                            </div>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('a005_cnpj') ? 'has-error' : ''}}">
                                    {!! Form::label('a005_cnpj', 'CNPJ', ['class' => 'control-label']) !!}
                                    {!! Form::text('a005_cnpj', null, ['class' => 'form-control cnpjMask cnpjvalido buscaexistente','autocomplete' => 'off']) !!}
                            ...
                            <div class="col-md-5">
                                <div class="form-group {{ $errors->has('a005_razao_social') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('a005_razao_social', null, ['class' => 'form-control','autocomplete' => 'off', 'maxlength'=>'50']) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('a005_nome_fantasia') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('a005_nome_fantasia', null, ['class' => 'form-control','autocomplete' => 'off', 'maxlength'=>'50']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group  {{ $errors->has('a005_email') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('a005_email', null, ['class' => 'form-control emailvalido validaunico', 'columnname'=>'a005_email', 'tablename'=>'t005_empresa' ,'pknametable'=>'a005_id_empresa', 'pkVal'=>'0','autocomplete' => 'off', 'maxlength'=>'50']) !!}
                                    {!! $errors->first('a005_email', '<p class="help-block">:message</p>') !!}
                                    <div class="help-block with-errors "></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10 jendereco">
                                <div class="form-group {{ $errors->has('a005_endereco') ? 'has-error' : ''}}">
                                    {!! Form::label('a005_endereco', 'Endereço*', ['class' => 'control-label']) !!}
                                    {!! Form::text('a005_endereco', null, ['class' => 'form-control jcampoEndereco','autocomplete' => 'off', 'maxlength'=>'300']) !!}
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('a005_numero_end') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('a005_numero_end', null, ['class' => 'form-control','autocomplete' => 'off', 'maxlength'=>'30']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('a005_bairro') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('a005_bairro', null, ['class' => 'form-control jcampoBairro','autocomplete' => 'off', 'maxlength'=>'200']) !!}
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group {{ $errors->has('a048_id_estado') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::select('a048_id_estado',$comboEstado??[],null,array('class' => 'form-control select2 jcampoEstado','id'=>'a048_id_estado','autocomplete' => 'off'))!!}
                            ...
                            <div class="col-md-3 ">
                                <div class="form-group {{ $errors->has('a047_id_cidade') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::select('a047_id_cidade',$comboCidade??[],null,array('class' => 'form-control select2 jcampoCidade','id'=>'a047_id_cidade','autocomplete' => 'off'))!!}
...
@push('js')
    <script>
        ...
        $("#a001_cpf").keyup(function ($value) {
            ...
            if($(this).val().length>=14)
            {
                /*$.alert({
                    theme: 'light',
                    title: 'ALERTA',
                    content: '='+$(this).val().length+'-'+$(".blockUI").length,
                });*/
                if($(".blockUI").length<=0)
                    buscaExistente(this);
        ...
        $("#a005_cnpj").keyup(function ($value) {
