...
<div class="row mb-5 justify-content-center">
    <div class="col-md-2">
        <input type="radio" id="contratante" name="a013_empresa_contratante" value="1"
            {{ isset($contrato) ? ($contrato->a013_empresa_contratante == '1' ? 'checked' : '') : 'checked' }}>
    ...
    <div class="col-md-2">
        <input type="radio" id="contratado" name="a013_empresa_contratante" value="2"
            {{ isset($contrato) && $contrato->a013_empresa_contratante == 2 ? 'checked' : '' }}>
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('a005_id_empresa') ? 'has-error' : '' }}">
            ...
            {!! Form::select('a005_id_empresa_select', $comboEmpresa, null, [
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('a005_id_empresa_cli_for') ? 'has-error' : '' }}">
            ...
            @else
                {!! Form::select('a005_id_empresa_cli_for', [], null, [
                    'class' => 'form-control select2 ',
                    'id' => 'a005_id_empresa_cli_for',
                    'required' => 'required',
                    'autocomplete' => 'off',
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('a013_numero_contrato') ? 'has-error' : '' }}">
            {!! Form::label('a013a013_numero_contrato', 'Código contrato', ['class' => 'control-label']) !!}
            {!! Form::text('a013_numero_contrato', null, [
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('a013_referencia_cliente') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_referencia_cliente', null, [
                'maxlength' => '20',
                'class' => 'form-control',
                'autocomplete' => 'off',
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('a013_referencia_fornecedor') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_referencia_fornecedor', null, [
                'maxlength' => '20',
                'class' => 'form-control',
                'autocomplete' => 'off',
                'readonly' => isset($isFornecedor) && !$isFornecedor,
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('a013_finalidade_cliente') ? 'has-error' : '' }}">
            ...
            {!! Form::textarea('a013_finalidade_cliente', null, [
                'class' => 'form-control',
                'maxlength' => '1024',
                'autocomplete' => 'off',
                'required' => 'required',
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('a013_finalidade_fornecedor') ? 'has-error' : '' }}">
            ...
            {!! Form::textarea('a013_finalidade_fornecedor', null, [
                'class' => 'form-control',
                'maxlength' => '1024',
                'autocomplete' => 'off',
                'rows' => 3,
...
<div class="row ">
    <div class="col-md-2">
        <div class="form-group {{ $errors->has('a013_data_inicio') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_data_inicio', null, [
                'id' => 'a013_data_inicio',
    ...
    <div class="col-md-1 periodo">
        <div class="form-group {{ $errors->has('a013_prazo_contrato') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_prazo_contrato', null, [
                'id' => 'valor_periodo',
            ...
            {!! Form::hidden('a013_prazo_contrato', null, [
                'class' => 'form-control',
                'autocomplete' => 'off',
                'required' => 'required',
            ]) !!}
    ...
    <div class="col-md-2">
        <div class="form-group {{ $errors->has('a013_data_renovacao') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_data_renovacao', null, [
    ...
    <div class="col-md-2">
        <div class="form-group {{ $errors->has('a013_dias_vencimento') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_dias_vencimento', null, [
                'class' => 'form-control numero3Mask',
                'autocomplete' => 'off',
                'required' => 'required',
                'data-toggle' => 'tooltip',
    ...
    <div class="col-md-3">
        <div class="form-group {{ $errors->has('a013_valor_fracao') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_valor_fracao', null, [
    ...
    <div class="col-md-3">
        <div class="form-group {{ $errors->has('a013_valor_extra') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_valor_extra', null, [
                'id' => 'a013_valor_extra',
                'class' => 'form-control moneyMaskCuston',
                'autocomplete' => 'off',
                'required' => 'required',
    ...
    <div class="col-md-3">
        <div class="form-group {{ $errors->has('a013_valor_total_contrato') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_valor_total_contrato', null, [
...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('a013_valor_extra_referencia') ? 'has-error' : '' }}">
            {!! Form::label('a013_valor_extra_referencia', 'Descrição do contrato', ['class' => 'control-label']) !!}
            {!! Form::textarea('a013_valor_extra_referencia', null, [
...
<div class="row">
    ...
    <!-- <div class="col-md-3">
        <div class="form-group {{ $errors->has('a013_valor_comissao') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_valor_comissao', null, [
                'class' => 'form-control moneyMaskCuston',
                'autocomplete' => 'off',
                '' => '',
            ]) !!}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('a013_periodicidade_reajuste') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_periodicidade_reajuste', null, [
                'class' => 'form-control numero3Mask',
                'autocomplete' => 'off',
            ]) !!}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('a013_indice_reajuste') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_indice_reajuste', null, [
                'class' => 'form-control ',
                'autocomplete' => 'off',
                'maxlength' => '500',
            ]) !!}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('a013_prazo_recisao') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_prazo_recisao', null, [
    ...
    <!-- <div class="col-md-4">
        <div class="form-group {{ $errors->has('a013_custo_recisao_antecipada') ? 'has-error' : '' }}">
            ...
            {!! Form::text('a013_custo_recisao_antecipada', null, [
                'class' => 'form-control moneyMaskCuston',
                'autocomplete' => 'off',
            ]) !!}
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('a013_obs_custo_revisao_antec') ? 'has-error' : '' }}">
            {!! Form::label('a013_obs_custo_revisao_antec', 'Condições para rescisão antecipada', [
                'class' => 'control-label',
            ]) !!}
            {!! Form::textarea('a013_obs_custo_revisao_antec', null, [
                'class' => 'form-control',
                'autocomplete' => 'off',
                'maxlength' => '256',
...
<div class="col-md-4">
    ...
    <div class="col-md-3">
        <div class="form-group {{ $errors->has('a001_id_usuario') ? 'has-error' : '' }}">
            ...
            {!! Form::select('a001_id_usuario', $comboResponsavel, null, [
                'class' => 'form-control select2 ',
                'id' => 'a001_id_usuario',
                'autocomplete' => 'off',
            ]) !!}
...
@endif-->
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('a013_obs_contrato_cliente') ? 'has-error' : '' }}">
            ...
            {!! Form::textarea('a013_obs_contrato_cliente', null, [
                'class' => 'form-control',
                'maxlength' => '500',
                'autocomplete' => 'off',
                'required' => 'required',
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('a013_obs_contrato_fornecedor') ? 'has-error' : '' }}">
            ...
            {!! Form::textarea('a013_obs_contrato_fornecedor', null, [
                'class' => 'form-control',
                'maxlength' => '500',
                'autocomplete' => 'off',
                'onkeyup' => 'countChar(this, 500)',
    ...
    @if (!isset($isFornecedorOrAdmin) || $isFornecedorOrAdmin)
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('a011_id_area') ? 'has-error' : '' }}">
                ...
                {!! Form::select('a011_id_area', $comboArea_contrato, null, [
                    'class' => 'form-control select2 ',
                    'id' => 'a011_id_area',
                    'required' => 'required',
                    'autocomplete' => 'off',
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('a013_classificacao') ? 'has-error' : '' }}">
            ...
            {!! Form::select('a013_classificacao', $comboClassificacao, null, [
                'class' => 'form-control select2 ',
            ...
            <div class="col-md-12">
                <div class="form-group ">
                    ...
                    <div style="margin-top: 7px;">
                        <label class="control-label">{!! Form::radio('a013_status', 'A', ($contrato->a013_status ?? 'A') == 'A' ? true : false, [
                            'id' => 'a013_status_A',
                            'class' => 'control-label a013_status',
                            'autocomplete' => 'off',
                        ]) !!} Ativo</label>&ensp;
                        <label class="control-label">{!! Form::radio('a013_status', 'D', ($contrato->a013_status ?? 'A') == 'D' ? true : false, [
                            'id' => 'a013_status_D',
                            'class' => 'control-label a013_status',
                            'autocomplete' => 'off',
                        ]) !!} Inativo</label>&ensp;
                        <label class="control-label">{!! Form::radio('a013_status', 'C', ($contrato->a013_status ?? 'A') == 'C' ? true : false, [
                            'id' => 'a013_status_C',
                            'class' => 'control-label a013_status',
                            'autocomplete' => 'off',
                        ]) !!} Cancelado</label>&ensp;
                        <label class="control-label">{!! Form::radio('a013_status', 'V', ($contrato->a013_status ?? 'A') == 'V' ? true : false, [
                            'id' => 'a013_status_V',
                            'class' => 'control-label a013_status',
                            'autocomplete' => 'off',
                        ]) !!} Vencido</label>&ensp;
                ...
                <div class="form-group ">
                    ...
                    <div style="margin-top: 7px;">
                        <label class="control-label">
                            {!! Form::checkbox('a013_aceita_termo', '1', ($contrato->a013_aceita_termo ?? '0') == '1' ? true : false, [
                    ...
                    <div class="jMotraDataUserCancelou" style="margin-top: 7px;display: none;">
                        <label class="control-label">Data: <span class="dataCancelamento"
                                style="font-weight:normal;">{{ $contrato->a013_data_cancelado ?? '' }}</span></label>&ensp;<label
                            class="control-label">Usuário: <span
                                style="font-weight:normal;">{{ $contrato->usuarioCancelou ?? Auth::user()->name }}</span></label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function selectClienteFornecedor() {
            $('#a005_id_empresa_cli_for').select2({
                ...
                ajax: {
                    url: '/app.dealix.com.br/empresa_buscaExistente/true/' + $(
