...
<div class="outrosDoc">
    ...
    <div data-id="{{ $documento->a014_id_documento }}" class="row doc-row">
        <div class="col-md-6"> 
            <div class="form-group has-error has-danger"> 
                <label class="control-label" style="width: 100%;">Documento:</label> 
                <a href="/storage/app/public{{ $documento->a014_documento }}" download>Baixar arquivo</a>
                <div onclick='deleteDoc({{ $documento->a014_id_documento }})' class="btn btn-xs btn-danger ml-5"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></div>
                <div class="help-block with-errors"></div> 
            </div> 
        </div> 
        <div class="col-md-2"> 
            <div class="form-group"> 
                <label for="a014_outro_doc_obs{{ $documento->a014_id_documento }}" class="control-label">Observação</label> 
                <input class="form-control" id="a014_outro_doc_obs{{ $documento->a014_id_documento }}" name="a014_outro_doc_obs[{{ $documento->a014_id_documento }}]" type="text" value="{{ $documento->a014_obs }}" maxlength="500" required> 
                <div class="help-block with-errors"></div> 
            </div> 
        </div>
    </div>
