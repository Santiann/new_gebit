...
<div class="box-body">
    <div class="row">
        <div class="col-md-4">
            {!! Form::label('nova_pendencia', 'Título da anotação:', ['class' => 'control-label']) !!}
    ...
    <div class="row">
        <div class="col-md-8 mt-2">
            <br>
            <button type="button" class="ml-2 pull-right button-modal btn bg-info" onclick="addPendencia()">
