...
class CompromissoController extends Controller
{
    ...
    public function datatable(Request $request)
    {
        ...
        return Datatables::of(
            Compromisso::query()
                ...
                ->where('a022_tipo', 2)
                ->select('a022_recorrencia','a022_data_inicio','a022_data_fim','a022_id_compromisso','t022_compromisso.a005_id_empresa','t022_compromisso.a013_id_contrato','a022_classificacao','a022_finalidade','a022_data_vencimento','a022_valor_pagar','a022_uso_vital','a022_data_pagamento','a022_valor_pago','a022_forma_pagamento','a022_status')
                ...
                ->groupBy('a022_id_compromisso','t022_compromisso.a005_id_empresa','t022_compromisso.a013_id_contrato','a022_classificacao','a022_finalidade','a022_data_vencimento','a022_valor_pagar','a022_uso_vital','a022_data_pagamento','a022_valor_pago','a022_forma_pagamento','a022_status','t005_empresa.a005_nome_fantasia','t005_empresa.a005_nome_completo','a013_numero_contrato','a022_recorrencia','a022_data_inicio','a022_data_fim')

        )
        ->addColumn('action', function ($row) use ($edit,$delete) {
            $acoes = "";
            if($edit){
                $acoes .= '<a class="btn btn-xs btn-primary" title="Editar Compromisso"  href="/compromisso/'.$row->a022_id_compromisso.'/edit" ><span class="fa fa-edit" aria-hidden="true"></span></a> ';
            }

            if($delete){
                $acoes .= '<form method="POST" action="/compromisso/'.$row->a022_id_compromisso.'" style="display:inline">
            ...
            ->editColumn('a022_data_inicio',function($row){
                return Carbon::createFromFormat('Y-m-d',$row->a022_data_inicio)->format('d/m/Y');
            })
            ->editColumn('a022_data_fim',function($row){
                return Carbon::createFromFormat('Y-m-d',$row->a022_data_fim)->format('d/m/Y');
            })
            ->editColumn('a022_recorrencia',function($row){
                return ucfirst($row->a022_recorrencia);
            })
    ...
    public function index(Request $request)
    {
        ...
        return view('sistema.compromisso.index', compact('comboEmpresa'));
    }
    ...
    public function create()
    {
        ...
        return view('sistema.compromisso.create', compact('comboEmpresa','comboContrato','comboClassificacao','comboStatus','comboEmpresaClieFor'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $requestData['a022_tipo'] = 2;
        $requestData['a022_valor_pagar'] = isset($requestData['a022_valor_pagar']) ? $this->converteDecimalDB($requestData['a022_valor_pagar']) : null;
        $requestData['a022_data_inicio'] = Carbon::createFromFormat('d/m/Y',$requestData['a022_data_inicio'])->format('Y-m-d');
        $requestData['a022_data_fim'] = Carbon::createFromFormat('d/m/Y',$requestData['a022_data_fim'])->format('Y-m-d');
    ...
    public function edit($id)
    {
        ...
        $compromisso->a022_data_inicio = Carbon::createFromFormat('Y-m-d',$compromisso->a022_data_inicio)->format('d/m/Y');
        $compromisso->a022_data_fim = Carbon::createFromFormat('Y-m-d',$compromisso->a022_data_fim)->format('d/m/Y');
        ...
        return view('sistema.compromisso.edit', compact('compromisso','comboEmpresa','comboContrato','comboClassificacao','comboStatus','comboEmpresaClieFor','arquivos','readonly', 'required'));
    }
    ...
    public function relatorio(Request $request)
    {
        ...
        return view('sistema.compromisso.relatorio', compact('comboEmpresa','comboClassificacao','comboEmpresaFor'));
    }
        ...
        return Datatables::of(
            Compromisso::query()
                ...
                ,'a013_numero_contrato'
                    ,'t005_empresa.a005_nome_fantasia','t005_empresa.a005_nome_completo')
        )
