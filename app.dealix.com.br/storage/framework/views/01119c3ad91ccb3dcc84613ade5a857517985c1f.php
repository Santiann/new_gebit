    ...
    <script>
        $(function () {
            ...
            var chartCategoria = new Chart($chartCategoria, {
                type: 'bar',
                data: {
                    labels: '<?php echo e($arrDesc); ?>'.split("|-|"),
                    datasets: [
                        {
                            backgroundColor: '#17a2b8',
                            borderColor: '#007bff',
                            data: '<?php echo e($arrValues); ?>'.split("|-|")
                        },
                    ]
                },
                options: {
...
<?php /**PATH C:\xampp\htdocs\app\resources\views/sistema/dashboard/graficoCustoCategoriaContrato.blade.php ENDPATH**/ ?>