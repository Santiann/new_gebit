<?php if(!isset($item['topnav']) || (isset($item['topnav']) && !$item['topnav'])): ?>
    ...
    <?php else: ?>
        <li <?php if(isset($item['id'])): ?> id="<?php echo e($item['id']); ?>" <?php endif; ?> class="nav-item <?php if(isset($item['submenu'])): ?><?php echo e($item['submenu_class']); ?><?php endif; ?>">
            ...
            >
                <span class="base-icon"><i class="icon <?php echo e($item['icon'] ?? 'far fa-fw fa-circle'); ?> <?php echo e(isset($item['icon_color']) ? 'text-' . $item['icon_color'] : ''); ?>"></i></span>
                <p class="txt-link">
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\app\resources\views/vendor/adminlte/partials/menu-item.blade.php ENDPATH**/ ?>