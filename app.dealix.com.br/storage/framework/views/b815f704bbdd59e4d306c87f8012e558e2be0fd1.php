<?php if(config('adminlte.layout_topnav') or (isset($item['topnav']) && $item['topnav'])): ?>
  ...
  <?php elseif(is_array($item)): ?>
      <li <?php if(isset($item['id'])): ?> id="<?php echo e($item['id']); ?>" <?php endif; ?> class="nav-item <?php echo e($item['top_nav_class']); ?>">
          ...
          >
              <i class="icon <?php echo e($item['icon'] ?? 'far fa-fw fa-circle'); ?> <?php echo e(isset($item['icon_color']) ? 'text-' . $item['icon_color'] : ''); ?>"></i>
  ...
  <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\app\resources\views/vendor/adminlte/partials/menu-item-top-nav.blade.php ENDPATH**/ ?>