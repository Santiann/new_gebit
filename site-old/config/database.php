    ...
    */
    ...
    'connections' => [
        ...
        'mysql_system' => [
            ...
            'host'      => env('DB_HOST_SYSTEM', env('DB_HOST', 'localhost')),
            'port'      => env('DB_PORT_SYSTEM', env('DB_PORT_SYSTEM', 3306)),
            'database'  => env('DB_DATABASE_SYSTEM'),
            'username'  => env('DB_USERNAME_SYSTEM', env('DB_USERNAME', '')),
        ...
        'pgsql' => [
            ...
            'host'     => '127.0.0.1',
            'port'     => '3306',
            'database' => 'evento_digital_painel_october',
            'username' => 'root',
            'password' => 'root',
            'charset'  => 'utf8',
            'prefix'   => '',
