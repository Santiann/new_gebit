...
class ResetPassword extends ComponentBase
{
    ...
    public function onRestorePassword()
    {
        ...
        \Flash::success(Lang::get('rainlab.user::lang.reset_password.restore_email_sent'));
    ...
    public function onResetPassword()
    {
        $rules = [
            'code'     => 'required',
            'password' => ['required', 'regex: "^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{'.UserModel::getMinPasswordLength().',255}$"']
        ];
