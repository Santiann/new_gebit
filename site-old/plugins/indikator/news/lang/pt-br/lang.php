...
return [
    ...
    'form' => [
        ...
        'newsletter_content_tab' => 'Conteúdo da newsletter',
        'featured' => 'Destaque',
        'hidden' => 'Está oculto?',
        'yes' => 'Sim',
        'no' => 'Não',
        ...
        'seo_desc' => 'Descrição',
        'seo_image' => 'OG imagem',
        'newsletter_content_description' => 'A newsletter não é enviada automaticamente, é necessário criar a postagem e depois clicar em "Enviar newsletter".',
        // Subscribers
        'name' => 'Nome',
        'email' => 'E-mail',
        'comment' => 'Comentário',
